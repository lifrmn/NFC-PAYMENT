...
const styles = StyleSheet.create({ // StyleSheet.create() mengoptimalkan style dan memberikan validasi tipe di TypeScript
  ...
  header: {
    ...
    // warna garis bawah abu muda
  },
  backButton: {
    width: 40, // lebar area sentuh tombol kembali
    // lebar area sentuh tombol kembali
    height: 40, // tinggi area sentuh tombol kembali
    // tinggi area sentuh tombol kembali
  ...
  // ukuran dan warna ikon panah kembali
  ...
  // ScrollView mengisi sisa ruang di bawah header
  content: { padding: 20 }, // padding konten dalam ScrollView
  // padding konten dalam ScrollView
  ...
  // baris tombol pilih kartu berjajar horizontal dengan gap
  cardOption: {
    flex: 1, // setiap opsi mengisi ruang secara merata
    // setiap opsi mengisi ruang secara merata
    borderWidth: 2, // border tebal agar jelas
    // border tebal agar jelas
    borderColor: '#e2e8f0', // border abu muda (tidak dipilih)
    // border abu muda (tidak dipilih)
  ...
  cardOptionSelected: {
    ...
    // border biru saat dipilih
    backgroundColor: '#EFF6FF', // latar biru sangat muda saat dipilih
    // latar biru sangat muda saat dipilih
  },
  ...
  submitBtn: {
    ...
    // hijau emerald untuk aksi positif
