...
const styles = StyleSheet.create({ // StyleSheet.create = membuat kumpulan style tampilan React Native yang dioptimalkan
  ...
  headerSpacerLarge: {
    ...
    // Sama dengan lebar backText agar judul benar-benar di tengah
  },
  ...
  content: {
    ...
    // Mengisi sisa ruang di bawah header
  },
  ...
  errorIcon: {
    ...
    // Sangat besar agar dominan di layar
  ...
  instructionBox: {
    ...
    // Garis tebal di kiri (aksen warna)
  ...
  instructionText: {
    ...
    // Ukuran kecil untuk instruksi
    color: '#2c3e50', // Navy gelap
    // Navy gelap
    lineHeight: 22, // Spasi baris agak lebar agar mudah dibaca
    // Spasi baris agak lebar agar mudah dibaca
  },
  ...
  backButton: {
    ...
    // Padding kiri-kanan agar tombol tidak terlalu sempit
  ...
  userBalance: {
    ...
    // Hijau agar terlihat sebagai angka positif/saldo
  ...
  warningCard: {
    ...
    // Kuning pucat untuk peringatan ringan
  ...
  warningText: {
    ...
    // Cokelat tua untuk kontras di latar kuning
    textAlign: 'center', // Perataan teks
    // Perataan teks
  },
  ...
  cardStatusCard: {
    ...
    // Hijau muda untuk status sukses
    padding: 15, // Jarak dalam semua sisi
    // Jarak dalam semua sisi
    borderRadius: 8, // Kelengkungan sudut elemen
    // Kelengkungan sudut elemen
  ...
  cardStatusUid: {
    ...
    // Monospace agar UID terlihat seperti kode teknis
  ...
  cardStatusSubtext: {
    ...
    // Kecil untuk keterangan tambahan
    color: '#155724', // Sama dengan warna teks lain di area hijau
    // Sama dengan warna teks lain di area hijau
  },
  ...
  actionButton: {
    ...
    // Padding besar agar mudah disentuh
    borderRadius: 12, // Sudut membulat
    // Sudut membulat
  ...
  disabledButton: {
    ...
    // Redup sebagai tanda tidak aktif
  },
