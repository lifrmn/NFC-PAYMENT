...
const styles = StyleSheet.create({ // StyleSheet.create = membuat kumpulan style tampilan React Native yang dioptimalkan
  ...
  header: {
    ...
    // Salam dan tombol berjajar horizontal
    justifyContent: 'space-between', // Salam di kiri, tombol di kanan
    // Salam di kiri, tombol di kanan
  ...
  notificationDot: {
    ...
    // Mengapung di atas tombol
    top: 10, // Jarak dari atas tombol
    // Jarak dari atas tombol
    right: 10, // Jarak dari kanan tombol
    // Jarak dari kanan tombol
  ...
  saldoLabel: {
    ...
    // Putih di atas latar biru
    opacity: 0.9, // Sedikit transparan agar label tidak dominan
    // Sedikit transparan agar label tidak dominan
  },
  ...
  topUpButton: {
    ...
    // Latar putih kontras di atas biru
  ...
  // Ukuran ikon Top Up dengan jarak kanan ke teks
  ...
  menuItem: {
    ...
    // Setiap item ambil lebar yang sama
    alignItems: 'center', // Ikon dan label di tengah
    // Ikon dan label di tengah
  ...
  // Emoji menu besar berwarna putih di atas biru
  ...
  menuLabel: {
    ...
    // Abu-abu sedang agar tidak terlalu mencolok
    ...
    // Spasi baris kecil agar dua baris muat
  },
  ...
  transactionSection: {
    ...
    // Padding bawah besar agar tidak tertimpa bottom nav
  },
  ...
  // Tanggal kecil abu-abu di item transaksi
  ...
  navItemCenter: {
    ...
    // Tombol melayang 20dp ke atas bottom nav
  },
...
// Ekspor agar bisa digunakan di DashboardScreen.tsx
